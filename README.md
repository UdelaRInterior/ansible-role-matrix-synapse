...
element_version: '1.8.5'
# Local source to Element config.json templates file.
# Useful for overwriting if you want to use your own templates
element_configuration_template_src: var/www/element/config.json.j2
...
# Leave it empty if you don't want to overwrite the default Element welcome page
element_welcome_page_template_src: '' # eg: 'var/www/element/custom-welcome.html.j2'
